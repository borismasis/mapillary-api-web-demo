...
![Screenshot](https://d2xsxph8kpxj0f.cloudfront.net/310519663316776087/Ziisy4gRDKAkXF5BRBaVrK/mapillary-demo-screenshot_aef98471.png)
...
Visit **[borismasis.github.io/mapillary-api-web-demo](https://borismasis.github.io/mapillary-api-web-demo/)** — the app loads with a default access token and is ready to use immediately.
...
```bash
git clone https://github.com/borismasis/mapillary-api-web-demo.git
cd mapillary-api-web-demo/docs
